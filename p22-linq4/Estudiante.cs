public class Estudiante
{
    ...
    public override string ToString()=>
    	$"Matricula: {Matricula,6} Nombre: {Nombre,-15} Domicilio: {Domicilio, -15} Municipio: {Municipio, -18} Sexo: {(Sexo=='H'?"Hombre":"Mujer")} Edad: {Edad,4} Becado: {(Becado?"Becado":"No Becado")} Califs: {string.Join(",",Califs)}";
}